	...
	private ListView mDrawerList;
	  ...
	  @Override
		public void onStart() {
			...
			SharedPreferences preferences1 =  context.getSharedPreferences("AAST", 0);
			...
			Display display = context.getWindowManager().getDefaultDisplay(); // get the
																		// display
					    ...
					    public void onClick(View v) {
							...
							try {
								...
								if (currentapiVersion <= android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH){
									Intent i = new Intent(context.getApplicationContext(), TesttActivity.class);
