...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public int insert_result(result_item res) {
		...
		Cursor cursor = db.query(
				...
				new String[] { String.valueOf(res.user_id),
						String.valueOf(res.term_id),
						String.valueOf(res.course_code) }, // d. selections args
				null, // e. group by
				null, // f. having
				null, // g. order by
				null); // h. limit
...

		{
			...
			int i = db.update(
					...
					new String[] { String.valueOf(res.user_id),
							String.valueOf(res.term_id),
							String.valueOf(res.course_code) } // selection args
					);
			// 4. close
			db.close();
		}
	...
	public int insert_scheduele(scheduele_slot sch) {
		...
		Cursor cursor = db
				.query("scheduele", // a. table
						...
						new String[] { String.valueOf(sch.user_id),
								String.valueOf(sch.day),
								String.valueOf(sch.from),
								String.valueOf(sch.to) }, // d. selections args
						null, // e. group by
						null, // f. having
						null, // g. order by
						null); // h. limit
