...
public class STDWEBService1Soap
{
    ...
    public STDWEBService1Soap(){}

    public STDWEBService1Soap (STDWEBIServiceEvents callback)
    {
        this.callback = callback;
    }
    public STDWEBService1Soap(STDWEBIServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public STDWEBService1Soap(STDWEBIServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    {
        STDWEBExtendedSoapSerializationEnvelope envelope= new STDWEBExtendedSoapSerializationEnvelope(STDWEBExtendedSoapSerializationEnvelope.VER11);
        return envelope;
    }
