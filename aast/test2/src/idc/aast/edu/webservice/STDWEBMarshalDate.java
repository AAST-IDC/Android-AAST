...
public class STDWEBMarshalDate implements Marshal
{
    ...
    {
        return STDWEBHelper.ConvertFromWebService(parser.nextText());
    }
    ...
    {
        writer.text(STDWEBHelper.getDateFormat().format((Date)obj));
    }
}
