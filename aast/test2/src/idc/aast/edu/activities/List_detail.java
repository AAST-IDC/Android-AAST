...
import idc.aast.edu.adapters.ListDetailsAdapter;
 ...
 */
@TargetApi(10)
public class List_detail extends ActionBarActivity implements TabListener {
...
//		arr3.add(count.substring(n33 + 1));
		ListDetailsAdapter adap = new ListDetailsAdapter(this, arr2, arr2);
